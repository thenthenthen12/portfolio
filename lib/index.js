$(function(){
    ...
    $('.slide--0 .intro__txt .text:nth-child(1)').click(function(){
        ...
        $('.slide--0:hover .left1').removeClass('on')
        $('.slide--0:hover .left1').addClass('on1')
        $('.slide--0:hover .left2').addClass('on1')
        $('.intro__title').addClass('on')

    })

    $('.slide--0').mouseenter(function(){
        $('.slide--0:hover .left1').addClass('on')
        $('.slide--0:hover .left2').addClass('on')
    })
